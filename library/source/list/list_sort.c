...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/05/20 15:26:32 by pollivie          #+#    #+#             */
/*   Updated: 2024/05/20 15:26:55 by pollivie         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "../../include/clib.h"

static t_node *list_sorted_merge(t_node *left, t_node *right, int (*f)(uintptr_t d1, uintptr_t d2))
{
	t_node *result;
